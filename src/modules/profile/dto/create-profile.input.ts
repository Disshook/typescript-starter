...
/**
 * Create Profile Input DTO
 *
 * Input type for creating a new user profile.
 * All fields are optional except userId (which is typically set from context).
 *
 * Requirements:
...
export class CreateProfileInput {
  ...
  @IsDateString(
    {},
    { message: 'Birth date must be a valid date in ISO 8601 format' },
  )
  birthDate?: string;
}
